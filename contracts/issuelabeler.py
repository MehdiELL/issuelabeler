...
# IssueLabeler - AI issue classifier on GenLayer.
...
class IssueLabeler(gl.Contract):
    items: DynArray[Item]
    ...
    def evaluate(self, item_id: int) -> None:
        ...
        def leader_fn():
            ...
            prompt = f"""You triage software issues. Classify the ISSUE as a bug report, a feature request, or a question.
...
Classify the CONTENT as exactly one of: bug, feature, question.
Also give an integer confidence score from 0 to 100, and a one-sentence reason.

Respond with ONLY JSON: {{"label": "<one of: bug, feature, question>", "score": <integer 0-100>, "reasoning": "<one sentence>"}}"""
